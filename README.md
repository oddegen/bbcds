...
The detection pipeline is not implemented yet. Model loading, video scanning, worker inference, adaptive sampling, playback restriction, benchmark collection, and direct CORS URL mode are future product phases defined in `ARCHITECTURE.md`.
